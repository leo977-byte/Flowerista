...
class ProductVariant(models.Model):
    ...
    color_name = models.CharField(max_length=50)  # e.g., "Blossom Pink", "Sunflower Yellow", "Lavender"
    color_hex = models.CharField(max_length=7, default="#E8839B") # HEX code for dynamic theme switcher
